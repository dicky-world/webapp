        ...
        <div>
          <div className='buttons-desktop'>
            <div onClick={openModal} id='join'>
              <button className='joinButton'>{txt.join} <span className='siteName'>{txt.siteName}</span></button>
            </div>
            <div onClick={openModal} id='login'><button className='loginButton'>{txt.login}</button></div>
          </div>
          <div className='buttons-mobile'>
            <div><Link to={{pathname: '/join'}}>
              <button className='joinButton'>{txt.join} <span className='siteName'>{txt.siteName}</span></button></Link>
            </div>
